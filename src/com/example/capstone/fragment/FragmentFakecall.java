...
import com.example.capstone.activities.IncommingCall;
...
//		arraylist.add("	¹Ù·Î½ÃÀÛ");
//		arraylist.add("5ÃÊ ÈÄ ");
//		arraylist.add("15ÃÊ ÈÄ ");
//		arraylist.add("30ÃÊ ÈÄ ");
//		arraylist.add("1ºÐ ÈÄ");
//		arraylist.add("5ºÐ ÈÄ");
//		arraylist.add("30ºÐ ÈÄ ");
//		
//		ArrayAdapter <String> adapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item,arraylist);
//		secSpinner.setPrompt("°ñ¶óºÁ!");
...
//		});
		...
		ok=(ImageButton)rootView.findViewById(R.id.OK);
		ok.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				if(stringcallername==null || stringcallerphonenumber ==null){
					...
					alert.setMessage("ÀÌ¸§°ú ÀüÈ­¹øÈ£¸¦ ÀÔ·ÂÇØÁÖ¼¼¿ä");
					alert.show();
				}
				else
	...
	private void setAlarm(Context context, long second){
		...
		if(stringcallername==null || stringcallerphonenumber==null){
			...
			empty.setTitle("ÀÌ¸§°ú ÀüÈ­¹øÈ£¸¦ ÀÔ·ÂÇØÁÖ¼¼¿ä!");
			empty.setCancelable(false);
			empty.setPositiveButton("È®ÀÎ", new DialogInterface.OnClickListener() {
...
//			stringcallerphonenumber=null;
		...
		case SHOW_RING:
			...
			ring.setText("º§¼Ò¸®¢º"+ringtoneName+"¢¸");
			break;
		}
	}
}
